...
public class ProtoBufferTest {
	...
	public static void main(String[] args) throws Exception {
		...
		try{
		//JSON File is here
		String content = new String(Files.readAllBytes(Paths.get(args[0].trim())));//   ("/home/exa1/Downloads/Protos/100.txt"
        jsontxtarr = new JSONObject(content);
        compare = args[1].trim().toLowerCase(); //"byteobj";
		...
		//	System.out.println(outputJson);
			...
			byte[] outputByte = readByteFromUrl("http://localhost:45670/path9");
